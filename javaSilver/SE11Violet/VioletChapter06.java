 ...
 * @date 2021-01-19 / 09:32-10:09 (37分)
 * @correctRate ①32.00 ％ ( 〇8問 / 全25問 )
 * @correctRate ②88.00 ％ ( 〇22問 / 全25問 )
 * @correctRate ③72.00 ％ ( 〇18問 / 全25問 )
 */
...
〇 2: D
× 3: C => 〇: A
    c.show()サブクラスにないときは superのインスタンスで探す
    superにないときはコンパイルエラー
〇 4: E
〇 5: B
〇 6: B
...
〇 17: C
× 18: D => 〇: A
    非staticから staticはアクセス可能
〇 19: A
〇 20: D
× 21: A, D => 〇: A, F
    d -> int i = -1; return i;
    ラムダ内の変数は、ラムダの外の変数と同じものは不可
〇 22: A
× 23: A => 〇: E
    foo(() -> 10)はメソッドの呼び出しであるから
    foo(10)でいいのでは？
...
× 24: E / 不変リストを改変 => 〇: C
    (黒本)◆固定長Listの作り方
        ...
        -> UnsupportedOperationException(in runtime)-> コンパイルは通るので注意。
× 25: D => 〇: E 上記
